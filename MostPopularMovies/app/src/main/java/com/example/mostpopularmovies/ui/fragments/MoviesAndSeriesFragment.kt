...
import com.example.mostpopularmovies.databinding.FragmentMoviesAndSeriesBinding
...
@AndroidEntryPoint
class MoviesAndSeriesFragment : Fragment() {

    private val viewModel: MovieViewModel by viewModels()
    private lateinit var binding: FragmentMoviesAndSeriesBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentMoviesAndSeriesBinding.inflate(inflater)
    ...
    private fun configStateView(movieDomain: List<MovieDomain>?) {
        movieAdapter.addData(movieDomain)
    }
    ...
    companion object {
        fun newinstance() = MoviesAndSeriesFragment()
    }
}